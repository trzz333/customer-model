          ...
          <div id="result-printable">
            ...
            {!deep ? (
              ...
              <details className={`rounded-xl border border-card-border bg-card-muted p-5 text-sm text-muted-fg leading-relaxed ${exp.methodology ? "" : "export-hidden"}`} open={!financeLed}>
                ...
                <p className="mt-2 mb-2">One rule governs what this model includes: a behavioral effect earns a place only if it survives replication, and it is sized to that replicated effect, which is often smaller than the famous headline figure. Effects that did not hold up, such as social priming, are left out on purpose rather than faked. This tool is meant to be a check on AI hand-waving, so it does not hand-wave about itself.</p>
