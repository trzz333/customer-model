        ...
        <section>
          ...
          <div id="result-printable">
            ...
            <div className="rounded-xl border border-card-border bg-card-muted p-5 text-sm text-muted-fg leading-relaxed">
              ...
              <p className="mb-2">The behavioral mechanism in the engine is loss aversion: a perceived price rise or value drop is weighted more heavily than an equal-size improvement, by a factor λ (default 2.25, after Tversky &amp; Kahneman 1992; meta-analytic estimates run lower). λ is held constant across worlds as the shared science; what changes between worlds is who the customers are. A present-bias term adds a pull toward an immediate competitor discount. These are deliberate simplifications, not the full prospect-theory value function — the categorical moves you choose, not λ, do most of the work, which is the point: a business is judged on its moves.</p>
